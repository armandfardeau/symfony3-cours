...
use JustBundle\Entity\Chevalier;
...
class ChevalierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $chevaliers = $em->getRepository('JustBundle:Chevalier')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('JustBundle\Form\ChevalierType', $chevalier);
    ...
    {
        $deleteForm = $this->createDeleteForm($chevalier);
        $editForm = $this->createForm('JustBundle\Form\ChevalierType', $chevalier);
