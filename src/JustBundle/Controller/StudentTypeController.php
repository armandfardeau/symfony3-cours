...
use JustBundle\Entity\StudentType;
...
class StudentTypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $studentTypes = $em->getRepository('JustBundle:StudentType')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('JustBundle\Form\StudentTypeType', $studentType);
    ...
    {
        $deleteForm = $this->createDeleteForm($studentType);
        $editForm = $this->createForm('JustBundle\Form\StudentTypeType', $studentType);
