...
class StudentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $students = $em->getRepository('JustBundle:Student')->findAll();
    ...
    {
        $student = new Student();
        $form = $this->createForm('JustBundle\Form\StudentType', $student);
    ...
    {
        $deleteForm = $this->createDeleteForm($student);
        $editForm = $this->createForm('JustBundle\Form\StudentType', $student);
